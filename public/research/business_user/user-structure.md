...
- 1 Account สามารถเป็น Owner ของหลาย ORG
...
#### 1.2.2 ORG (KYB / Organization Verified)
**Definition**: องค์กรที่ผ่านการยืนยัน (KYB - Know Your Business)

**Characteristics**:
- ต้องผ่าน KYB
- ถือว่าร้านทั้งหมดสามารถขายของได้ (เมื่อ ORG ผ่าน KYB)
- สามารถมีร้านได้แค่ 1 ร้าน (1 ORG = 1 Shop)
- 1 Account สามารถสร้างหลาย ORG
...
#### 2.2.2 ORG (KYB / Organization Verified)
...
5. เมื่อผ่าน KYB → ORG Verified → สามารถใช้งานได้
...
- เชิญสมาชิกทีมเข้า ORG
- กำหนด role และ permissions
- สมาชิกทีมสามารถทำงานใน ORG ได้
...
- 1 team member สามารถอยู่ในหลาย Shop ได้ (ถ้าเป็น ORG เดียวกัน)
...
- Role และ permissions สำหรับจัดการใน ORG
- ตัวอย่าง roles:
  - **ORG Owner**: สิทธิ์เต็มรูปแบบใน ORG
  - **ORG Admin**: จัดการ ORG (แต่ไม่สามารถลบ ORG)
...
- **Actor**: ORG Owner
- **Scenario**:
  1. ORG Owner เชิญ Team Member A เข้า ORG
...
- **Actor**: ORG Owner
- **Scenario**:
  1. ORG Owner เชิญ Team Member C เข้า ORG
...
1. **Check Organization Permission**: ตรวจสอบสิทธิ์ใน ORG
...
- **Average Team Size**: ขนาดทีมเฉลี่ยต่อ ORG
...
2. **Shop Assignment**: Team member สามารถอยู่ในหลาย Shop ได้หรือไม่? (ถ้าเป็น ORG เดียวกัน)
...
- **รองรับหลายองค์กร**: Account สามารถมีหลาย ORG
