...
- **Structure**: Account → ORD (KYB) → Team Members
...
- **ORD (KYB)**: องค์กรที่ผ่านการยืนยัน
  - 1 ORD = 1 Shop
  - เมื่อ ORD ผ่าน KYB → ร้านทั้งหมดสามารถขายของได้
- **Shop**: ร้านของผู้ขาย
...
- **Structure**: Account → ORD (KYB) → Shop → Branch
- **Permissions**:
...
- **⚠️ Note**: Full Inventory Management System เป็น Future Feature (Phase 2+)
